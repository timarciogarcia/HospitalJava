...
<body>
	<div>
		<h1>Editar Estado</h1>
			<form name="frmestadoedicao" action="updateestado">
				<table width="100%">
				   <tbody>
						<tr>
							<td>
								<label for="idestado">Código</label><br>
								<input type="text" SIZE=3 name="idestado" id="idestado" readonly value="<%out.print(request.getAttribute("idestado"));%>">
							</td>
						</tr>
						<tr>
							<td>
								<label for="uf">Unidade Federativa</label><br>
								<input autofocus type="text" SIZE=3  name="uf" id="uf" MAXLENGTH=2 value="<%out.print(request.getAttribute("uf"));%>">
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td align="right" >
								<input type="button" value="Salvar" class="Botao1" onclick="validarestado()" title="Salva as Alterações">
