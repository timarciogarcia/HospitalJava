...
<body>
	<div>
		<h1>Editar Espécie</h1>
			<form name="frmpelagemedicao" action="updatepelagem">
				<table width="100%">
				   <tbody>
						<tr>
							<td>
								<label for="idestado">Código</label><br>
								<input type="text" SIZE=3 name="idpelagem" id="idpelagem" readonly value="<%out.print(request.getAttribute("idpelagem"));%>">
							</td>
						</tr>
						<tr>
							<td>
								<label for="nome">Nome da Pelagem</label><br>
								<input type="text" name="nome" id="nome"  SIZE=55  MAXLENGTH=45	value="<%out.print(request.getAttribute("nome"));%>">
							</td>
						</tr>
						<tr>
							<td align="right" >
								<input type="button" value="Salvar" class="Botao1" onclick="validarpelagem()" title="Salva as Alterações">
